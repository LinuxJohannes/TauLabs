 ...
 * @{
 * @addtogroup CoreF4 CoreF4 support files
 * @{
 *
 * @file       pios_board.c
 ...
 * CoreF4 board. Please see hardware/Production/CoreF4/pinout.txt for
 * an overview.
 */
...
//		panic(1);
	...
	if (boot_count < 3) {
		...
		HwCoreF4SetDefaults(HwCoreF4Handle(), 0);
	...
	HwCoreF4USB_VCPPortGet(&hw_usb_vcpport);

	if (!usb_cdc_present) {
		/* Force VCP port function to disabled if we haven't advertised VCP in our USB descriptor */
		hw_usb_vcpport = HWCOREF4_USB_VCPPORT_DISABLED;
	}
	...
	case HWCOREF4_USB_VCPPORT_DISABLED:
		break;
	case HWCOREF4_USB_VCPPORT_USBTELEMETRY:
		...
		break;
	case HWCOREF4_USB_VCPPORT_COMBRIDGE:
#if defined(PIOS_INCLUDE_COM)
		{
...
#endif	/* PIOS_INCLUDE_COM */
		break;
	case HWCOREF4_USB_VCPPORT_DEBUGCONSOLE:
#if defined(PIOS_INCLUDE_COM)
#if defined(PIOS_INCLUDE_DEBUG_CONSOLE)
		{
	...
	HwCoreF4USB_HIDPortGet(&hw_usb_hidport);

	if (!usb_hid_present) {
		/* Force HID port function to disabled if we haven't advertised HID in our USB descriptor */
		hw_usb_hidport = HWCOREF4_USB_HIDPORT_DISABLED;
	}
	...
	case HWCOREF4_USB_HIDPORT_DISABLED:
		break;
	case HWCOREF4_USB_HIDPORT_USBTELEMETRY:
#if defined(PIOS_INCLUDE_COM)
		{
			uint8_t * rx_buffer = (uint8_t *) pvPortMalloc(PIOS_COM_TELEM_USB_RX_BUF_LEN);
			uint8_t * tx_buffer = (uint8_t *) pvPortMalloc(PIOS_COM_TELEM_USB_TX_BUF_LEN);
	...
	uint8_t hw_DSMxBind;
	HwCoreF4DSMxBindGet(&hw_DSMxBind);
	...
	/* UART1 Port */
	uint8_t hw_uart1;
	HwCoreF4Uart1Get(&hw_uart1);
	switch (hw_uart1) {
	case HWCOREF4_UART1_DISABLED:
		break;
	case HWCOREF4_UART1_GPS:
	...
	case HWCOREF4_UART1_SBUS:
		...
		break;
	case HWCOREF4_UART1_DSM2:
	case HWCOREF4_UART1_DSMX10BIT:
	case HWCOREF4_UART1_DSMX11BIT:
		...
		break;
	case HWCOREF4_UART1_HOTTSUMD:
	case HWCOREF4_UART1_HOTTSUMH:
	...
	/* UART2 Port */
	uint8_t hw_uart2;
	HwCoreF4Uart2Get(&hw_uart2);
	switch (hw_uart2) {
	case HWCOREF4_UART2_DISABLED:
		break;
	case HWCOREF4_UART2_TELEMETRY:
...
#endif
		break;
	case HWCOREF4_UART2_DSM2:
	case HWCOREF4_UART2_DSMX10BIT:
	case HWCOREF4_UART2_DSMX11BIT:
#if defined(PIOS_INCLUDE_DSM)
		{
			enum pios_dsm_proto proto;
			switch (hw_uart2) {
...
#endif	/* PIOS_INCLUDE_DSM */
		break;
	case HWCOREF4_UART2_HOTTSUMD:
	case HWCOREF4_UART2_HOTTSUMH:
#if defined(PIOS_INCLUDE_HSUM)
		{
			enum pios_hsum_proto proto;
			switch (hw_uart2) {
...
#endif	/* PIOS_INCLUDE_HSUM */
		break;
	case HWCOREF4_UART2_DEBUGCONSOLE:
	...
	case HWCOREF4_UART2_MAVLINKTX:
		...
		break;
	case HWCOREF4_UART2_MAVLINKTX_GPS_RX:
	...
	/* UART3 Port */
	uint8_t hw_uart3;
	HwCoreF4Uart3Get(&hw_uart3);
	switch (hw_uart3) {
	case HWCOREF4_UART3_DISABLED:
		break;
	case HWCOREF4_UART3_TELEMETRY:
#if defined(PIOS_INCLUDE_TELEMETRY_RF) && defined(PIOS_INCLUDE_USART) && defined(PIOS_INCLUDE_COM)
...
#endif
		break;
	case HWCOREF4_UART3_DSM2:
	case HWCOREF4_UART3_DSMX10BIT:
	case HWCOREF4_UART3_DSMX11BIT:
#if defined(PIOS_INCLUDE_DSM)
		{
			enum pios_dsm_proto proto;
			switch (hw_uart3) {
...
#endif	/* PIOS_INCLUDE_DSM */
	case HWCOREF4_UART3_HOTTSUMD:
	case HWCOREF4_UART3_HOTTSUMH:
#if defined(PIOS_INCLUDE_HSUM)
		{
			enum pios_hsum_proto proto;
			switch (hw_uart3) {
	...
	uint8_t hw_rcvrport;
	HwCoreF4RcvrPortGet(&hw_rcvrport);

	switch (hw_rcvrport) {
	case HWCOREF4_RCVRPORT_DISABLED:
		break;
	case HWCOREF4_RCVRPORT_PWM:
		...
		break;
	case HWCOREF4_RCVRPORT_PPM:
	case HWCOREF4_RCVRPORT_PPMOUTPUTS:
	...
	switch (hw_rcvrport) {
		...
		case HWCOREF4_RCVRPORT_PPM:
			...
			break;
		case HWCOREF4_RCVRPORT_PPMOUTPUTS:
		case HWCOREF4_RCVRPORT_OUTPUTS:
#ifdef PIOS_INCLUDE_SERVO
	...
	HwCoreF4MPU6050DLPFGet(&hw_mpu6050_dlpf);
	enum pios_mpu60x0_filter mpu6050_dlpf = \
	    (hw_mpu6050_dlpf == HWCOREF4_MPU6050DLPF_256) ? PIOS_MPU60X0_LOWPASS_256_HZ : \
	    (hw_mpu6050_dlpf == HWCOREF4_MPU6050DLPF_188) ? PIOS_MPU60X0_LOWPASS_188_HZ : \
	    (hw_mpu6050_dlpf == HWCOREF4_MPU6050DLPF_98) ? PIOS_MPU60X0_LOWPASS_98_HZ : \
	    (hw_mpu6050_dlpf == HWCOREF4_MPU6050DLPF_42) ? PIOS_MPU60X0_LOWPASS_42_HZ : \
	    (hw_mpu6050_dlpf == HWCOREF4_MPU6050DLPF_20) ? PIOS_MPU60X0_LOWPASS_20_HZ : \
	    (hw_mpu6050_dlpf == HWCOREF4_MPU6050DLPF_10) ? PIOS_MPU60X0_LOWPASS_10_HZ : \
	    (hw_mpu6050_dlpf == HWCOREF4_MPU6050DLPF_5) ? PIOS_MPU60X0_LOWPASS_5_HZ : \
	    pios_mpu6050_cfg.default_filter;
	PIOS_MPU6050_SetLPF(mpu6050_dlpf);

	uint8_t hw_mpu6050_samplerate;
	HwCoreF4MPU6050RateGet(&hw_mpu6050_samplerate);
	uint16_t mpu6050_samplerate = \
	    (hw_mpu6050_samplerate == HWCOREF4_MPU6050RATE_200) ? 200 : \
	    (hw_mpu6050_samplerate == HWCOREF4_MPU6050RATE_333) ? 333 : \
	    (hw_mpu6050_samplerate == HWCOREF4_MPU6050RATE_500) ? 500 : \
	    (hw_mpu6050_samplerate == HWCOREF4_MPU6050RATE_666) ? 666 : \
	    (hw_mpu6050_samplerate == HWCOREF4_MPU6050RATE_1000) ? 1000 : \
	    (hw_mpu6050_samplerate == HWCOREF4_MPU6050RATE_2000) ? 2000 : \
	    (hw_mpu6050_samplerate == HWCOREF4_MPU6050RATE_4000) ? 4000 : \
	    (hw_mpu6050_samplerate == HWCOREF4_MPU6050RATE_8000) ? 8000 : \
	...
	if (PIOS_MPU6500_Init(pios_spi_gyro_accel_id, 0, &pios_mpu6500_cfg) != 0)
		panic(2);
	if (PIOS_MPU6500_Test() != 0)
		panic(2);
	...
	switch(hw_gyro_range) {
		case HWQUANTON_GYRORANGE_250:
			PIOS_MPU6500_SetGyroRange(PIOS_MPU60X0_SCALE_250_DEG);
			break;
		case HWQUANTON_GYRORANGE_500:
			PIOS_MPU6500_SetGyroRange(PIOS_MPU60X0_SCALE_500_DEG);
			break;
		case HWQUANTON_GYRORANGE_1000:
			PIOS_MPU6500_SetGyroRange(PIOS_MPU60X0_SCALE_1000_DEG);
			break;
		case HWQUANTON_GYRORANGE_2000:
			PIOS_MPU6500_SetGyroRange(PIOS_MPU60X0_SCALE_2000_DEG);
			break;
	}
	...
	switch(hw_accel_range) {
		case HWQUANTON_ACCELRANGE_2G:
			PIOS_MPU6500_SetAccelRange(PIOS_MPU60X0_ACCEL_2G);
			break;
		case HWQUANTON_ACCELRANGE_4G:
			PIOS_MPU6500_SetAccelRange(PIOS_MPU60X0_ACCEL_4G);
			break;
		case HWQUANTON_ACCELRANGE_8G:
			PIOS_MPU6500_SetAccelRange(PIOS_MPU60X0_ACCEL_8G);
			break;
		case HWQUANTON_ACCELRANGE_16G:
			PIOS_MPU6500_SetAccelRange(PIOS_MPU60X0_ACCEL_16G);
			break;
	}

	// the filter has to be set before rate else divisor calculation will fail
	uint8_t hw_mpu6500_dlpf;
	HwQuantonMPU6000DLPFGet(&hw_mpu6000_dlpf);
	enum pios_mpu60x0_filter mpu6500_dlpf = \
	    (hw_mpu6500_dlpf == HWQUANTON_MPU6500DLPF_256) ? PIOS_MPU60X0_LOWPASS_256_HZ : \
	    (hw_mpu6500_dlpf == HWQUANTON_MPU6500DLPF_188) ? PIOS_MPU60X0_LOWPASS_188_HZ : \
	    (hw_mpu6500_dlpf == HWQUANTON_MPU6500DLPF_98) ? PIOS_MPU60X0_LOWPASS_98_HZ : \
	    (hw_mpu6500_dlpf == HWQUANTON_MPU6500DLPF_42) ? PIOS_MPU60X0_LOWPASS_42_HZ : \
	    (hw_mpu6500_dlpf == HWQUANTON_MPU6500DLPF_20) ? PIOS_MPU60X0_LOWPASS_20_HZ : \
	    (hw_mpu6500_dlpf == HWQUANTON_MPU6500DLPF_10) ? PIOS_MPU60X0_LOWPASS_10_HZ : \
	    (hw_mpu6500_dlpf == HWQUANTON_MPU6500DLPF_5) ? PIOS_MPU60X0_LOWPASS_5_HZ : \
	    pios_mpu6500_cfg.default_filter;
	PIOS_MPU6500_SetLPF(mpu6500_dlpf);

	uint8_t hw_mpu6500_samplerate;
	HwQuantonMPU6500RateGet(&hw_mpu6500_samplerate);
	uint16_t mpu6500_samplerate = \
	    (hw_mpu6500_samplerate == HWQUANTON_MPU6500RATE_200) ? 200 : \
	    (hw_mpu6500_samplerate == HWQUANTON_MPU6500RATE_333) ? 333 : \
	    (hw_mpu6500_samplerate == HWQUANTON_MPU6500RATE_500) ? 500 : \
	    (hw_mpu6500_samplerate == HWQUANTON_MPU6500RATE_666) ? 666 : \
	    (hw_mpu6500_samplerate == HWQUANTON_MPU6500RATE_1000) ? 1000 : \
	    (hw_mpu6500_samplerate == HWQUANTON_MPU6500RATE_2000) ? 2000 : \
	    (hw_mpu6500_samplerate == HWQUANTON_MPU6500RATE_4000) ? 4000 : \
	    (hw_mpu6500_samplerate == HWQUANTON_MPU6500RATE_8000) ? 8000 : \
	    pios_mpu6500_cfg.default_samplerate;
	PIOS_MPU6500_SetSampleRate(mpu6500_samplerate);
#endif
...
#if defined(PIOS_INCLUDE_HMC5883)
	{
		...
		HwCoreF4MagnetometerGet(&Magnetometer);

		if (Magnetometer == HWCOREF4_MAGNETOMETER_EXTERNALI2C) {
			...
			HwCoreF4ExtMagOrientationGet(&ExtMagOrientation);

			enum pios_hmc5883_orientation hmc5883_orientation = \
				(ExtMagOrientation == HWCOREF4_EXTMAGORIENTATION_TOP0DEGCW) ? PIOS_HMC5883_TOP_0DEG : \
				(ExtMagOrientation == HWCOREF4_EXTMAGORIENTATION_TOP90DEGCW) ? PIOS_HMC5883_TOP_90DEG : \
				(ExtMagOrientation == HWCOREF4_EXTMAGORIENTATION_TOP180DEGCW) ? PIOS_HMC5883_TOP_180DEG : \
				(ExtMagOrientation == HWCOREF4_EXTMAGORIENTATION_TOP270DEGCW) ? PIOS_HMC5883_TOP_270DEG : \
				(ExtMagOrientation == HWCOREF4_EXTMAGORIENTATION_BOTTOM0DEGCW) ? PIOS_HMC5883_BOTTOM_0DEG : \
				(ExtMagOrientation == HWCOREF4_EXTMAGORIENTATION_BOTTOM90DEGCW) ? PIOS_HMC5883_BOTTOM_90DEG : \
				(ExtMagOrientation == HWCOREF4_EXTMAGORIENTATION_BOTTOM180DEGCW) ? PIOS_HMC5883_BOTTOM_180DEG : \
				(ExtMagOrientation == HWCOREF4_EXTMAGORIENTATION_BOTTOM270DEGCW) ? PIOS_HMC5883_BOTTOM_270DEG : \
